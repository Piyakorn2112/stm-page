...
export default function WorkContent() {
  return (
    <>
      ...
      <section className={site.section} style={accent("var(--indigo)")}>
        <div className={`${site.container} ${styles.workCenter}`}>
          <span className={site.eyebrow}>Systems of people</span>
          <h2 className={site.heading}>
            Not roles. Not departments. Systems of <em className={site.accentWord}>people</em>.
          </h2>
      ...
      <section className={`${site.section} ${site.sectionAlt}`} style={accent("var(--orange)")}>
        <div className={site.container}>
          <span className={site.eyebrow}>How we operate</span>
          <h2 className={site.heading}>
            The way we <em className={site.accentWord}>build</em>.
          </h2>
      ...
      <section className={site.section} style={accent("var(--blue)")}>
        <div className={`${site.container} ${styles.alignSplit}`}>
          <div className={styles.alignVisual}>
            <TeamField className={styles.teamField} />
          </div>
          <div className={styles.alignText}>
            <span className={site.eyebrow}>Structure</span>
            <h2 className={site.heading}>
              Aligned, not <em className={site.accentWord}>isolated</em>.
            </h2>
            <p className={site.lede}>Teams operate independently — but not in isolation.</p>
            <p className={site.body}>Across teams, we maintain shared layers of alignment:</p>
      ...
      <section className={`${site.section} ${site.sectionAlt}`} style={accent("var(--indigo)")}>
        <div className={site.container}>
          <span className={site.eyebrow}>The fit</span>
          <h2 className={site.heading}>
            Who <em className={site.accentWord}>thrives</em> here.
          </h2>
      ...
      {/* Closing — orange */}
      <section className={site.section} style={accent("var(--orange)")}>
        <div className={`${site.container} ${styles.workCenter}`}>
          <span className={site.eyebrow}>Not yet hiring</span>
          <h2 className={site.heading}>
            We’re not hiring yet. But we’re <em className={site.accentWord}>building</em>.
          </h2>
          <p className={site.lede}>
